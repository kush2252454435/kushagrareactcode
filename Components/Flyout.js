...
const engagement = [
  { name: 'Colleges', href: '#', icon: InformationCircleIcon },
  { name: 'Coaching Institutes', href: '#', icon: UsersIcon },
  { name: 'Twinning Programs', href: '#', icon: NewspaperIcon },
  { name: 'Events', href: '#', icon: BriefcaseIcon },
  { name: 'Q & A', href: '#', icon: ShieldCheckIcon },
]
const resources = [
  { name: 'Placement Reports', href: 'https://www.educationtimes.com/counsellors', icon: UserGroupIcon },
  { name: 'Student Offers', href: '#', icon: GlobeAltIcon },
  { name: 'Education Loan', href: '#', icon: BookOpenIcon },
  { name: 'Artticles of Newsroom', href: '#', icon: VideoCameraIcon },
]
const recentPosts = [
  {
    id: 1,
